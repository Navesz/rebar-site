...
import { EsculturaDaMarca } from '@/components/escultura-da-marca'
...
export function Hero({ idioma }: { idioma: Idioma }) {
  ...
  return (
    <CoreografiaDoHero className="border-b border-border/60">
      ...
      <div className="hero-com-escultura mx-auto w-full max-w-5xl px-4 pt-16 pb-20 sm:px-6 sm:pt-24 sm:pb-28">
        ...
        <EsculturaDaMarca textos={t.home.escultura} />
      </div>
    </CoreografiaDoHero>
  )
}
