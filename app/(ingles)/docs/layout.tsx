 ...
 */
export default function LayoutDeDocs({ children }: Readonly<{ children: ReactNode }>) {
  return <MolduraDeDocumentacao idioma={IDIOMA_PADRAO}>{children}</MolduraDeDocumentacao>
}
